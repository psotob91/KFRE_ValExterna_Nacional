...
imp.datosA <- imp.datosA |> 
  ...
  mutate(eventdf = factor(eventd), 
        risk2y = 1 - st0_imp2y ^ exp(fc_coef_imp2y * kfre_pi(imp.datosA)), 
        risk5y = 1 - st0_imp5y ^ exp(fc_coef_imp5y * kfre_pi(imp.datosA))) |> 
...
rio::export(subdist_df_stack, here("Data", "Tidy", "subdist_df_stack_3a4_2y_metA.rds"))
rio::export(subdist_df_dec, here("Data", "Tidy", "subdist_df_dec_3a4_2y_metA.rds"))
...
rio::export(subdist_df_stack, here("Data", "Tidy", "subdist_df_stack_3a4_2y_metB.rds"))
rio::export(subdist_df_dec, here("Data", "Tidy", "subdist_df_dec_3a4_2y_metB.rds"))
...
rio::export(subdist_df_stack, here("Data", "Tidy", "subdist_df_stack_3a4_2y_metC.rds"))
rio::export(subdist_df_dec, here("Data", "Tidy", "subdist_df_dec_3a4_2y_metC.rds"))
...
rio::export(subdist_df_stack, here("Data", "Tidy", "subdist_df_stack_3a4_2y_metD.rds"))
rio::export(subdist_df_dec, here("Data", "Tidy", "subdist_df_dec_3a4_2y_metD.rds"))
...
```{r}
plot_cal_metA | plot_cal_metB | plot_cal_metC | plot_cal_metD -> plot_comp_calib
