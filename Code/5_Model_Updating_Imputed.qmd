...
datos.recal <- data.frame(
  ...
  sobrev_recal = c(p2y$fc.aj.risk.basal.mean, 
                   p5y$fc.aj.risk.basal.mean, 
                   p2y_2$fc.aj.risk.basal, 
                   p5y_2$fc.aj.risk.basal,
                   p2y_csh$fc.aj.risk.basal.csh, 
                   p5y_csh$fc.aj.risk.basal.csh, 
                   p2y_2.csh$fc.aj.risk.basal.csh, 
                   p5y_2.csh$fc.aj.risk.basal.csh), 
  fc_coef = c("No aplica", 
              "No aplica", 
              p2y_2$fc.aj.coef, 
              p5y_2$fc.aj.coef, 
              "No aplica", 
              "No aplica", 
              p2y_2.csh$fc.aj.coef.csh, 
              p5y_2.csh$fc.aj.coef.csh)
)
